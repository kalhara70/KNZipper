const webApps = [
            ...
            { name: 'Investment Tracker', description: 'Monitor your investments and make informed decisions with real-time market insights.', link: 'file_generator.html', category: 'development' }
        ];
